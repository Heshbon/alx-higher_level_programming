...
# 0. Get all states
  ...
  + <u>[0-select_states.py](https://github.com/Heshbon/holbertonschool-higher_level_programming/blob/main/0x0F-python-object_relational_mapping/0-select_states.py)</u>: Python script that lists all states from the database hbtn_0e_0_usa.
